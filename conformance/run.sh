...
# TestEveryServedRouteIsInThePermissionManifest (T-61), which is a Go test —
# a route the manifest never learned about cannot be caught from in here,
# because everything in here starts from the manifest.

...
**在下線這條路上，它的效果就是換座艙燈號和廣播一則 delta。就這樣。**

🔴 **這句話的修訂史比它的內容更值得讀。** 我為它寫過四個版本，前三個都是在替它找一個「其實有用」的理由：

1. 「時鐘照走」——下線那條根本沒有時鐘可走。
2. 「它是 SSE 重連被放行、以及自請重啟被接受的依據」——**兩半都假**。打不打它都連得上；自請重啟看的是有沒有 live 連線加意圖仍是上線，碼註解甚至直說這個宣告曾經是自請重啟被**誤拒**的原因。
3. 「它打的那個時間錨被強制下線的判定拿去用」——那個 stamp 是 `IF UNSET`，而按下線時錨已經被無條件蓋好了，所以 agent 這一次是 **no-op**。

三次都被獨立審查打回，三次都是我在為同一句話找新理由。**當你發現自己第三次為同一段內容辯護時，該懷疑的是自己，不是它。** 誠實的答案一開始就在那裡：在這條路上它就是一個顯示層的宣告，沒有更多。

⇒ 連帶兩條：**被打回之後當場補上的理由，跟原本那個一樣需要被查證**（修正不會因為它是修正就自動為真）；以及**「這東西一定有更深的用途」本身就是一個要被查證的假設**，不是查證的起點。
...
本文經過一次逐句事實核對加兩輪獨立審查。**每一輪都有新的錯，而且後兩輪的錯全部出在「為了修上一輪而新寫的句子」裡。**
...
不是「要更小心」——三輪下來每一輪我都很小心。可執行的只有一條：**任何新寫或改寫的句子，都要當成從未被查證過的斷言重新查一次，包括（尤其是）那些為了修正錯誤而寫的。**

...
| 燈號 | 意思 |
|---|---|
| 綠色 | 最近一次**排程**備份還在新鮮窗內，你有退路。 |
| 紅色驚嘆號 | 出事了。點它會跳到監控頁的**備份健康**卡，卡上寫是哪一種：**從來沒跑過**、**太舊**（排程可能停了）、或**這次失敗**。 |
| 灰色 | **還不知道**——看門狗還沒評估過，或座艙問不到伺服器。**灰色不是「大概沒事」**：不知道有沒有退路，就跟沒有退路一樣要當回事。 |

兩個刻意的行為，免得你誤判：

- **只有排程備份算數。** 你自己手動跑的 `ocserverd backup`、或升級前的自動備份，都**不會**讓這顆燈轉綠——否則一次手動備份就會把一個已經停掉的排程蓋過去，再瞞你 12 小時。
- **紅燈只有排程備份真的成功才會消。** 重開伺服器不會讓它變綠；壞了三天，第三天看到的仍然是紅的，而且卡上寫著「已經壞了三天」。

正常運作時它不會用任何方式打擾你——只有那顆燈的顏色。

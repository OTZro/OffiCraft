...
view=full 只在 HTTP list seam 表示整個 pane 的一次請求；light/default 行為不變、未知 view 回 400、MCP 不宣傳這個參數。等待卡的 expire 規則以 server 為準：owner/admin 或卡片作者可過期自己的 waiting 卡；其他人 403，已回答 409。

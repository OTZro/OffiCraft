...
export interface Api {
  ...
  /**
   * ONE named retained revision, IN FULL (T-1170). This is the only read that
   * carries a revision's text, and it is deliberately per-revision: the reader
   * opens exactly one at a time, so downloading three documents to show one was
   * paying for two nobody asked for.
   *

...
export const en: Dict = {
  ...
  workerDetail: {
    ...
    // is the STAFF boot context minus the whole persona — the role journal, its
    // insight and its lessons (a worker has no role, so it has none of the three);

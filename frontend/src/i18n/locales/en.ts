...
export const en: Dict = {
  ...
  settings: {
    ...
    bootDocSave: "Save",
    bootDocActionFailed: "That did not go through — try again.",
    ...
    bootDocOverCapLead: "Now ",
    bootDocOverCapMid: " characters, over the limit of ",
    bootDocOverCapTail: " — remove some before saving.",
    bootDocPasteSection: "Paste new version",
    bootDocApplySection: "Apply this section",
    bootDocDiscardSection: "Undo this section",
    bootDocCancelSection: "Cancel",
    bootDocPreview: "Preview",
    bootDocBackToEdit: "Back to editing",
    bootDocPending: "Unsaved",
    bootDocPreamble: "(opening)",
    bootDocEditorPlaceholder: "Paste the whole new version of this section here",
    bootDocDirtyNote: "Applied sections are not saved yet; leaving this page loses them.",

...
export const en: Dict = {
  ...
  tasks: {
    ...
    artifacts: {
      ...
      versionsSideLabel: "Which version",
      ...
      versionsDiffLive: "This is the current version — there is nothing to compare it with",
      versionsDiffNote: "“Current version” is what the server holds right now, not what this card happens to be holding.",

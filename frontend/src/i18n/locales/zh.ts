...
export const zh = {
  ...
  settings: {
    ...
    docCapDuty: "角色定義字數上限",
    docCapDutySub:
      "一個角色的角色定義的字數上限（1000–100000）。下限就是出廠預設，所以只能調高——調低會讓現在合法的文件變成只能越寫越短。",
    docCapInsight: "Insight 字數上限",
    docCapInsightSub:
      "一個角色的 Insight 的字數上限（10000–100000）。下限就是出廠預設，所以只能調高。",
    docCapLearning: "學習經驗字數上限",
    docCapLearningSub:
      "一個角色的學習經驗的字數上限（10000–100000）。下限就是出廠預設，所以只能調高。",
    docCapManual: "任務手冊字數上限",
    docCapManualSub:
      "任務手冊的 SOP 與學習經驗，每一份各自的字數上限（10000–100000）。下限就是出廠預設，所以只能調高。",
    docUsage: "已用字數",
    chars: "字",

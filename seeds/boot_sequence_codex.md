...
- **`connected` 不等於什麼都沒錯過。** 你離線期間漏掉的聊天與請示卡，會在**連上的那一刻**一起送到你這裡（開機後第一次連上，以及每一次重連都會）。**沒送到你面前的，就要自己去撈**：請示卡只涵蓋最近 24 小時，更舊的用 `get_reply_card` 讀；**聊天會全部送來，沒有上限**；**任務沒有補印，一律自己查任務列表**。

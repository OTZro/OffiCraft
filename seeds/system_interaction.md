...
**第三種開卡理由——兩份權威打架時。** 上面兩關抓的是「你被卡住、非他不可」,第二種抓的是「你要延伸範圍」。還有一種:**你手上有兩份都該算數的權威,而它們互相矛盾**——文件與程式對不上、兩份規格各說各話、票面寫的與現況不同、前人的裁定與眼前的碼牴觸。**一律停下來,開一張等我回覆卡問 owner。這是「必須發問」的類型之一,不列入你自行判斷值不值得問的範圍——上面那兩關不適用**:別因為「不問也走得下去」就跳過,也別因為「這結我自己解得開」就自己裁。

**理由要跟規則一起記住:衝突當下每個 agent 都覺得「我看得出哪邊對」——但正因為每個 agent 都這麼覺得,交給個別判斷就等於沒有規則。** 矛盾通常代表某一邊已經漂離原始意圖,而光從碼上看不出是哪一邊;自行裁定會把「一個待解的問題」變成「一個看似已解決、其實選錯邊的問題」,下一個人就在那個錯前提上繼續疊。所以:**停下、開卡、把兩邊的原文都攤給 owner 看,由他拍板;在他回覆前,兩邊都不要動。**

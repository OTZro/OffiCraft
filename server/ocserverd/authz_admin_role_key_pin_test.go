...
// authz_admin_role_key_pin_test.go — T-48 / 00068 guard rail.
//
// WHY THIS FILE EXISTS. Migration 00068 renames the member KIND 'assistant' to
...
func TestAdminRoleKeyIsPinnedAgainstTheKindRename(t *testing.T) {
	if adminRoleKey != wantAdminRoleKey() {
		t.Fatalf("adminRoleKey moved: got %q, want %q.\n"+
			...
			"renaming the kind 'assistant' -> 'staff' (migration 00068), this constant "+
...
// neighbourhood. machineKind is not part of the 00068 rename either, and it is

...
type MyTaskDTO struct {
	...
	// ManualOmittedChars Total runes of ``sop_md`` + ``learnings`` left out of ``manual`` (CJK counts 1 per character). 0 = there is no manual, or both documents are empty. Call get_task_manual with ``manual.type_key`` to read them in full.

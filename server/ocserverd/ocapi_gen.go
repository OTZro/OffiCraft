...
type OutsourceWorkerDTO struct {
	...
	// DesiredMachineId The OWNER-PINNED machine placement (relocate target), the worker twin of member.desired_machine_id: "" = unpinned (manual preference decides), "auto" = idlest-online, or a concrete machine id. T-f190 additive-optional.
	DesiredMachineId *string `json:"desired_machine_id,omitempty"`

...
var t6020Opened = map[[2]string]string{
	...
	{"POST", "/api/update/upgrade"}:                                     "upgrade_software",
	...
	{"POST", "/api/machines/{machine_id}/bootstrap-here"}:               "bootstrap_machine_here",
	{"POST", "/api/machines/{machine_id}/teardown-here"}:                "teardown_machine_here",
	{"POST", "/api/machines/{member_id}/upgrade"}:                       "upgrade_machine",
	{"POST", "/api/tasks/{task_id}/terminate"}:                          "terminate_task",
	{"POST", "/api/tasks/{task_id}/message"}:                            "post_task_message",
	{"GET", "/api/outsource-workers/{id}/boot-context"}:                 "get_worker_boot_context",
